describe('Aeromodelling Program Test - 01:30 PM EST', () => {
    beforeEach(() => {
        ...
        cy.get('a.group.rounded-xl.bg-white.flex.flex-col', { timeout: 10000 })
            ...
            .then($elements => {
                ...
                for (let i = 0; i < $elements.length; i++) {
                    ...
                    // Check for matching workshop - 01:30 PM EST time slot
                    if (text.includes('Aeromodelling Program') &&
                        text.includes('Free') &&
                        text.includes('Sunday, August 24, 2025') &&
                        text.includes('Grade 5 to 8') &&
                        text.includes('English') &&
                        (text.includes('01:30 PM') || text.includes('1:30 PM'))) {
                        cy.log(`✅ Found matching Aeromodelling workshop for 1:30 PM at index ${i}`);
                        matchedElement = el;
                        break;
                    }
                }
